...
class CoopAct extends db
{
    ...
    {
        $sql = "select * from Co_op_Activity";
    ...
    {
        $sql = "select *  from Co_op_Activity  where co_id = '".$id."'";
        mysqli_query($this->db_link, "SET NAMES UTF8");
        if($result = mysqli_query($this->db_link, $sql)){
            $this->Close();
            return $result; 
    ...
    public function addact($co_name,$co_date,$co_time,$co_detail,$co_hours,$co_place,$co_StartTime,$co_StopTime,$Co_op_Type_co_type_id)
    {
        
        $sql = "insert into `Co_op_Activity` (`co_name`, `co_date`, `co_time`, `co_detail`, `co_hours`, `co_place`, `co_StartTime`, `co_StopTime`, `Co_op_Type_co_type_id`) values ('".$co_name."','".$co_date."','".$co_time."','".$co_detail."',".$co_hours.",'".$co_place."','".$co_StartTime."','".$co_StopTime."',".$Co_op_Type_co_type_id.")";
